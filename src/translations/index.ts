      ...
      list: [
        {
          ...
          details: {
            ...
            whatWeDid: [
              ...
              "**การอนุมัติเอกสารและคำขอ (Document Approval):** ระบบเวิร์กโฟลว์การอนุมัติใบคำขอและเอกสารภายในของฝ่ายบริหารและหัวหน้างาน",
        ...
        },
        {
          ...
          details: {
            ...
            whatWeDid: [
              ...
              "**ค้นหาและแนะนำร้านอาหารภายในมหาลัย:** ระบบค้นหา คัดกรองหมวดหมู่ และแสดงพิกัดร้านอาหารแผงลอย ศูนย์อาหาร และร้านค้าใกล้เคียงรอบตัวมหาวิทยาลัย",
            ...
            techHighlight: [
              ...
              "**พัฒนาส่วนติดต่อชุมชนและกิจกรรม:** ติดตั้งระบบกระดานความคิดเห็น การตอบกลับคอมเมนต์ และตัวบ่งชี้กระบวนการอัปโหลดความเร็วสูง",
              "**การป้องกันความปลอดภัยสังคมออนไลน์ด้วย AI:** เชื่อมต่อและเรียกใช้โมเดล [Perspective API](https://developers.perspectiveapi.com/) เพื่อประเมินค่าความเหมาะสมของตัวอักษรเรียลไทม์ ป้องกันภาษาท็อกซิกและประทุษวาจา",
              ...
              "**ควบคุมความสอดคล้องของโค้ดโปรเจกต์:** ร่วมพัฒนากับผู้เกี่ยวข้องผ่าน GitHub ในการแบ่งแยกกิ่งพัฒนาและรวมโค้ดหลังผ่านกระบวนการทดสอบเสร็จสมบูรณ์"
            ]
          }
        },
        {
    ...
    experience: {
      ...
      list: [
        ...
        },
        {
          ...
          caption: "บรรยากาศภายในแคมปัส มหาวิทยาลัยแม่ฟ้าหลวง จ.เชียงราย"
        },
        {
          id: 5,
